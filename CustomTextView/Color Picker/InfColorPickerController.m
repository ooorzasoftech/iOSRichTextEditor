...
- (void) presentModallyOverViewController: (UIViewController*) controller
{
	...
	/*UIBarButtonItem *doneBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem: UIBarButtonSystemItemAction
																						   target: self
																						   action: @selector(done:)];*/
    
    
    /*UIBarButtonItem *doneBtn = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"done_icon.png"] style:UIBarButtonItemStylePlain target:self action:@selector(done:)
                                                                             ];*/

    UIFont *font=[UIFont systemFontOfSize:18.0];
    
    NSDictionary *dict = @{NSFontAttributeName: font , NSBackgroundColorAttributeName:[UIColor blueColor] };
    ...
    [doneBtn setTitleTextAttributes:dict forState:UIControlStateNormal];
...
{
    [self.delegate colorPickerCancelButtonClicked: self];
}
